<h2><a href="https://www.geeksforgeeks.org/problems/prime-factorization/1?page=1&category=CPP&status=unsolved&sortBy=submissions">Prime Factorization</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a number <strong>n </strong>find the prime factorization of the number.</span></p>
